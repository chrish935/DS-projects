"""Following the examples of Ken Jee to gain some familiarity with making a dashboard using Streamlit.
Source material can be found at:  https://www.youtube.com/watch?v=Yk-unX4KnV4&ab_channel=KenJee"""
...
@st.cache
def load_data():
    df_agg = pd.read_csv(r'C:\Users\chris\Desktop\streamlit\Aggregated_Metrics_By_Video.csv').iloc[1:, :]
    df_agg_sub = pd.read_csv(r'C:\Users\chris\Desktop\streamlit\Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv(r'C:\Users\chris\Desktop\streamlit\Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv(r'C:\Users\chris\Desktop\streamlit\Video_Performance_Over_Time.csv')
...
if add_sidebar == 'Individual Video Analysis':
    ...
    fig2.add_trace(go.Scatter(x=first_30['days_published'], y=first_30['Views'].cumsum(), mode='lines', name='Current video', line=dict(color='firebrick', width=5)))
